...
class TrainOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--lambda_space', type=float, default=5.0, help='weight for space loss')
        parser.add_argument('--edge_weight', type=float, default=5.0, help='weight for edge loss')
        parser.add_argument('--texture_weight', type=float, default=5.0, help='weight for texture loss')
